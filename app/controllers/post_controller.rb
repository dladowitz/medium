class PostController < ApplicationController
  ...
  CLOUDFRONT_URL  = "https://d262ilb51hltx0.cloudfront.net"
  ...
  def index
    ...
    @authors = json_content["payload"]["references"]["User"].map{ |author| author }
  end
  ...
  def show
    ...
    @main_image = "#{CLOUDFRONT_URL}/fit/t/1600/672/#{json_content["payload"]["value"]["content"]["image"]["imageId"]}"
